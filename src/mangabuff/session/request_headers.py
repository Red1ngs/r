...
ProxyFatalCallback = Callable[[str], Any]
"""
Викликається BotHttpClient одразу, коли proxy_queue сигналізує про
фатальну (невідновну) поломку проксі — ProxyFatalError — незалежно від
того, стався це під час звичайної роботи чи під час реєстрації/логіну.
Синхронний виклик (без await): типовий приклад — Account.mark_dead(reason),
який лише виставляє стан. Акаунт одразу переходить у DEAD і лишається
таким до ручного втручання оператора.
"""
